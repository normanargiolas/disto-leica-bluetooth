...
@rem ##########################################################################
@rem
@rem  disto-leica startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute disto-leica
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" nor.example.leica.Launcher %CMD_LINE_ARGS%
